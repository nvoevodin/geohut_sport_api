...
const pool = mysql.createPool({
  ...
  app.post('/addImage',upload.single('fileData'), (req, res,next) => {
    ...
    var my_data = {
       ...
       pool.query("INSERT INTO geohut_sport.playgrounds_queue (site_id,site_name,country,city,site_address,latitude,longitude,image) values (uuid(),'"+my_data.name+"','"+my_data.country+"','"+my_data.city+"','"+my_data.address+"','"+my_data.lat+"','"+my_data.lon+"','"+my_data.image+"')", function (err, results) {
        if(err) {
            console.log(err)
            return res.send(err)
